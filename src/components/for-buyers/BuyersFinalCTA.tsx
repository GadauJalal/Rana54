...
export function BuyersFinalCTA() {
  return (
    <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#527E5F] to-[#3d5d48] p-12 lg:p-16 shadow-[0_20px_70px_-15px_rgba(0,0,0,0.3)]">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        <h2 className="text-5xl lg:text-6xl text-white mb-6 tracking-tight">
          Ready to Source High-Integrity Credits?
        </h2>
        
        <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto leading-relaxed">
          Join leading organizations building carbon portfolios backed by device-level verification and transparent impact.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
          <div className="p-4 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20">
            <div className="text-2xl text-[#F6B842] mb-1">Device-Level</div>
            <div className="text-sm text-white/70">Verification</div>
          </div>
          <div className="p-4 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20">
            <div className="text-2xl text-[#F6B842] mb-1">Complete</div>
            <div className="text-sm text-white/70">Audit Trails</div>
          </div>
          <div className="p-4 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20">
            <div className="text-2xl text-[#F6B842] mb-1">Real-World</div>
